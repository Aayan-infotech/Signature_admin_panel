...
export default function PlanList() {
  ...
  const fetchPlans = async () => {
    try {
      const response = await axios.get('https://signatouch.com/api/plan/getAllPlans')
  ...
  const fetchPlansById = async (id) => {
    try {
      const response = await axios.get(`https://signatouch.com/api/plan/getPlan/${id}`)
      console.log(response)
      if (response.status === 200) {
  ...
  const deletePlanById = async (id) => {
    try {
      const response = await axios.delete(`https://signatouch.com/api/plan/deletePlan/${id}`)
      console.log(response)
      if (response.status === 200) {
        fetchPlans()
      }
